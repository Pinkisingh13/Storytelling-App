...
// import 'package:storytelling_app/models/yearsmodel.dart';
...
final dummydata = [
  Start(
      ...
      title: 'Hey there! Welcome to AIYO ',
      description:
          'Craft your own stories or explore stories from our library. Your adventure, your way!'),
  Start(
      image: Image.asset(
      ...
      title: 'Step 1: Select Your Age ',
      description:
          'Start by picking your age group, we’ll then provide story themes that’s just right for you!'),
  Start(
      image: Image.asset(
      ...
      title: 'Step 2: Pick a Story Theme ',
      description:
          'Choose the kind of story you are in the mood for or excites you the most'),
  Start(
      image: Image.asset(
      ...
      title: 'Step 3: Add Characters ',
      description:
          'Every great story needs some awesome characters, doesn${"'"}t it? Pick from our cool collection or create your own!'),
  Start(
      image: Image.asset(
      ...
      description:
          'Your story, your rules! You ${"'"}re in control of how it feels, flows, and what it ultimately teaches!'),
  Start(
      image: Image.asset(
...
final storyBodyData = [
  StoryBodyModel(
      id: 'first',
      image: const AssetImage('assets/images/first_year/first.png'),
  ...
  StoryBodyModel(
      id: 'first',
      image: const AssetImage('assets/images/first_year/second.png'),
  ...
  StoryBodyModel(
      id: 'first',
      image: const AssetImage('assets/images/first_year/third.png'),
  ...
  StoryBodyModel(
      id: 'first',
      image: const AssetImage('assets/images/first_year/forth.png'),
  ...
  StoryBodyModel(
      id: 'first',
      image: const AssetImage('assets/images/first_year/fifth.png'),
  ...
  StoryBodyModel(
      id: 'first',
      image: const AssetImage('assets/images/first_year/sixth.png'),
  ...
  StoryBodyModel(
      id: 'second',
      image: const AssetImage('assets/images/second_year/first.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'second',
      image: const AssetImage('assets/images/second_year/second.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'second',
      image: const AssetImage('assets/images/second_year/third.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'second',
      image: const AssetImage('assets/images/second_year/forth.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'second',
      image: const AssetImage('assets/images/second_year/fifth.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'second',
      image: const AssetImage('assets/images/second_year/sixth.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'third',
      image: const AssetImage('assets/images/third_year/first.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'third',
      image: const AssetImage('assets/images/third_year/second.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'third',
      image: const AssetImage('assets/images/third_year/third.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'third',
      image: const AssetImage('assets/images/third_year/forth.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'third',
      image: const AssetImage('assets/images/third_year/fifth.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'third',
      image: const AssetImage('assets/images/third_year/sixth.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'forth',
      image: const AssetImage('assets/images/forth_year/first.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'forth',
      image: const AssetImage('assets/images/forth_year/second.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'forth',
      image: const AssetImage('assets/images/forth_year/third.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'forth',
      image: const AssetImage('assets/images/forth_year/forth.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'forth',
      image: const AssetImage('assets/images/forth_year/fifth.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
  StoryBodyModel(
      id: 'forth',
      image: const AssetImage('assets/images/forth_year/sixth.png'),
      title: 'The Lost Start ${"'"} s Journey',
      time: "2 Min read",
      discription:
          'The Journey of the Lost Star ${"'"} is a heartwarming tale for children aged 1-3, set in the celestial realm. It follows the adventures of Tara, a small, golden star, who gets lost while playing hide and seek. Her journey back home is illuminated by encounters with the Moon, playful comets, and the Bear Constellation, each offering guidance and encouragement.'),
